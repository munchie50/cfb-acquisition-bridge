# CFB Engine — Current Recovery Index v1.223

Status: **CURRENT ENTRY POINT — CFB PRODUCTION CHAMPION ACTIVE**
Date: 2026-09-26
Supersedes v1.221 as the current entry point. Historical evidence remains preserved.
...
## Superseded warnings
- v1.221 is superseded as current entry point by this file; its statement that production v1 remains champion/fallback is no longer current.
